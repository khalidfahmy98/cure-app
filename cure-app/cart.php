        ...
        <div class="category-list col-md-7">
           <h3>Cart Items</h3>
            <ul class="list-unstyled">
                ...
                <li class="media">
                  <img src="assets/imgs/1cart.jpg" class="mr-3" alt="...">
                  <div class="media-body">
                    <p class="mt-0 mb-1">Adidas Originals</p>
                    <p>Yung-96 Trainers-Footwear White/core black/offwhite 
                      <select>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                    ...
                    <div class="choose-item container">
                      <span>E84.99</span>
                        <div class="row">
                            <div class="remove-item"><i class="far fa-trash-alt"></i>Remove</div>
                            <div><i class="far fa-heart"></i>Move To Wish List</div>
                        </div>
                    </div>
                </div>
                </li>
                <li class="media">
                    <img src="assets/imgs/2cart.jpg" class="mr-3" alt="...">
                    <div class="media-body">
                      <p class="mt-0 mb-1">Adidas Originals</p>
                      <p>Yung-96 Trainers-Footwear White/core black/offwhite 
                        <select>
                  ...
                  <li class="media">
                    <img src="assets/imgs/3cart.jpg" class="mr-3" alt="...">
                    <div class="media-body">
                      <p class="mt-0 mb-1">Adidas Originals</p>
                      <p>Yung-96 Trainers-Footwear White/core black/offwhite 
                        <select>
              ...
              <div class="info-item">
                  <ul>
                      <li><i class="fas fa-info-circle"></i> Items Placed In This Bag Are Not Reserved</li>
                  </ul>
              </div>
              ...
              <div class="container">
                  <div class="row">
                    ...
                    <div class="total-item col-md-5">
                        <h4>Total</h4>
                        <ul class="list-unstyled">
                            <li>Subtotal <span>E126.97</span></li>
                            <li>Delivery <span>Free</span></li>
                            <li>Total <span>E126.97</span></li>
                        </ul>
                        <button type="button" class="btn btn-warning btn-lg btn-block">Go To Checkout</button>
                        <p>Have @ Git Card Or Voucher Code? These Can Be Redeemed In The Last step Of Checkout</p>
                    </div>
                  </div>
              </div>
