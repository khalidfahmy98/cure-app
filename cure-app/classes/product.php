...
class product{
    ...
    public function getProducts(){
        $data = $this->_db->aggergateJoin("warehousing","cure_organizations","authorized_products","org_id","treatment_id","org_id","product_id",array('warehousing.sell_visiblity','=',"1"));
        if ( $data->count() > 0 ){
            return $data->results();
        }
        return false;
