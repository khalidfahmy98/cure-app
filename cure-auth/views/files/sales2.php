...
<table id="dtBasicExample" class="table datatable table-striped table-bordered" cellspacing="0" width="100%">
  <thead>
    <tr>
      ...
      <th class="th-sm"> الكمية
      </th>
      <th class="th-sm">السعر 
      </th>
  ...
  <tbody>
    <tr>
      ...
      <td>
      <input type="button" class="btn btn-default" value="تأكيد الفاتورة" >
      <input type="button" class="btn btn-default" value="الرفض">
      <input type="button" class="btn btn-default" value="القبول">
      </td>
    </tr>
