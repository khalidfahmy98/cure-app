...
<table id="dtBasicExample" class="table datatable table-striped table-bordered" cellspacing="0" width="100%">
  <thead>
    <tr>
      ...
      <th class="th-sm">البريدالالكتروني
      </th>
      <th class="th-sm">الصورة
      </th>
      <th class="th-sm">اليوزر
      </th>
      <th class="th-sm">تاريخ التسجيل
      </th>
      <th class="th-sm">الصلاحية
      </th>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <input type="button" class="btn btn-default" value="فك البلوك">
      </td>
    </tr>
...
<!-- <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2020 <a href="#">Cure &copy;</a>.</strong> All rights
    reserved.
</footer>
</div>
